...
class UpdateModal extends Component {
    ...
    static getDerivedStateFromProps(props, current_state){ //Берем данные, которые передаем из компонента выше
        let employeeUpdate = {
            employeeName: null,
            employeeSalary: null,
        }
        ...
        //updating data from props. Только если поле пустое, иначе проверка выше
